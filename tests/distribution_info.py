...
from .scipy_replacement.base import (
...
class DistributionInfo(Generic[NP, EP, Domain]):
    ...
    def exp_to_scipy_distribution(
        self, p: EP
    ) -> ScipyDistribution | ScipyComplexDistribution | ScipyDiscreteDistribution:
    ...
    def exp_parameter_generator(self, rng: Generator, shape: Shape) -> EP:
        ...
        """
        return cast("EP", self.nat_parameter_generator(rng, shape).to_exp())
