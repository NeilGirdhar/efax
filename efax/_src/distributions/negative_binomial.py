...
class NegativeBinomialNP(NBCommonNP,
                         NaturalParametrization['NegativeBinomialEP', JaxRealArray, None]):
    ...
    @override
    @classmethod
    def sufficient_statistics(cls, x: JaxRealArray, fixed_parameters: FixedFailures
                              ) -> NegativeBinomialEP:
...
class NegativeBinomialEP(Samplable,
                         NBCommonEP,
                         ExpectationParametrization[NegativeBinomialNP, None]):
