...
from .parameter import BoundedBelowRealSupport, distribution_parameter, real_support
...
class ChiSquareNP(NaturalParametrization['ChiSquareEP']):
    ...
    and rate 1/2.
    """
    k_over_two_minus_one: RealArray = distribution_parameter(BoundedBelowRealSupport(-1.0), axes=0)
